...
public class FragmentUtils {
    ...
    public static void showFragmentGlobal(FragmentManager fragmentManager, Fragment fragment) {
        fragmentManager.beginTransaction().replace(R.id.nav_host_fragment_content_menu_inicio, fragment)
                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                .commit();
    }
}
